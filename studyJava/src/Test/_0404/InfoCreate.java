...
import Test._0404.Data.*;
import Test._0404.Methods.InputData;
import Test._0404.Registration.LectureRegistration;
import Test._0404.Registration.LectureTeacher;
...
public class InfoCreate {
    ...
    static {
        try {
            users = InputData.userDB();
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public static List<LectureRegistration> lectureRegistrations;
    static {
        try {
            lectureRegistrations = InputData.LectureRegistrationDB();
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static ArrayList<LectureTeacher> lectureTeachers = new ArrayList<>();
